...
public class MainActivity extends ActionBarActivity
{
    ...
    */
	...
	{
		File theDir = new File("/data/data/com.esc101.shikherverma.github.io.esc101/files/tcclibs");
		...
		if (!theDir.exists())
		{
			...
			copyFileFromAssets("binaries.zip", "/data/data/com.esc101.shikherverma.github.io.esc101/files/binaries.zip");
			copyFileFromAssets("libraries.zip", "/data/data/com.esc101.shikherverma.github.io.esc101/files/libraries.zip");
			unzip("/data/data/com.esc101.shikherverma.github.io.esc101/files/binaries.zip", "/data/data/com.esc101.shikherverma.github.io.esc101/files/");
			unzip("/data/data/com.esc101.shikherverma.github.io.esc101/files/libraries.zip", "/data/data/com.esc101.shikherverma.github.io.esc101/files/");
			shell("chmod 777 /data/data/com.esc101.shikherverma.github.io.esc101/files/buzybox");
			shell("chmod 777 /data/data/com.esc101.shikherverma.github.io.esc101/files/tcc");
			shell("chmod 777 /data/data/com.esc101.shikherverma.github.io.esc101/files/indent");
			shell("chmod 777 /data/data/com.esc101.shikherverma.github.io.esc101/files/file.sh");
			shell("rm /data/data/com.esc101.shikherverma.github.io.esc101/files/binaries.zip");
			shell("rm /data/data/com.esc101.shikherverma.github.io.esc101/files/libraries.zip");
			createDirectoryIfNeeded();
